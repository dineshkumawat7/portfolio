...
export const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(({ id, name, value, label, error, required, helperText,
  containerClassName = "", className = "", rows = 4, ...props }, ref) => {
